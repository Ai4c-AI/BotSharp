...
//    private static List<IBotSharpModule> _modules = new List<IBotSharpModule>();
...
//                    .Where(x => x.GetInterface(nameof(IBotSharpModule)) != null)
//                    .Select(x => Activator.CreateInstance(x) as IBotSharpModule)
//                    .ToList();
...
//    {
//        module.ConfigureServices(_services, _config);
